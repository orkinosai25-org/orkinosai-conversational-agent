...
This module provides comprehensive CMS (Content Management System) functionality for the SiteChat Agent, with a focus on user registration, authentication, and onboarding.
...
This module was migrated from the orkinosaiCMS repository and adapted to work with the SiteChat Agent. Key improvements:
