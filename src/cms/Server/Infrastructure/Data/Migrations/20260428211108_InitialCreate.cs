        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxBots = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OnboardingStep = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeatSlug = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    OrganizationId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    AvatarUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    TrainedDocumentsCount = table.Column<int>(type: "int", nullable: false),
                    TrainedUrlsCount = table.Column<int>(type: "int", nullable: false),
                    LastTrainedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    WidgetColor = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    WidgetPosition = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TrainingDocuments_Bots_BotId",
                        column: x => x.BotId,
                        principalTable: "Bots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainingUrls", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TrainingUrls_Bots_BotId",
                        column: x => x.BotId,
                        principalTable: "Bots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainingDocuments_BotId",
                table: "TrainingDocuments",
                column: "BotId");

            migrationBuilder.CreateIndex(
                name: "IX_TrainingUrls_BotId",
                table: "TrainingUrls",
                column: "BotId");
        }
